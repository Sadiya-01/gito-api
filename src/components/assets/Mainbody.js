                                ...
                                return(
                                    ...
                                    {Object.keys(mainbodyData[0][key]).map((mbData) => {
                                        ...
                                        // if(mainbodyData[0][key][mbData].id==this.state.id){
                                            if(mainbodyData[0][key][mbData].id){
                                            return(
                                                <div className="data"  style={{paddingTop: '5px'}}  id={`mbData${mainbodyData[0][key][mbData].id}`} ref={el => (this.idRefs[mainbodyData[0][key][mbData].id] = el)}>
